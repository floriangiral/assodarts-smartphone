...
enum RIBDocument {
    ...
    private static func draw(
        ...
        if let reference, !reference.isEmpty {
            ...
            write(
                tr("reference_to_quote_on_the_transfer"),
        ...
        write(
            tr("document_generated_by_assodarts_on_keep_it_for_your_paym \(Fmt.mediumDate(.now))"),
